...
String dateFormatted(int type){
 ...
 if(type==0) {return display;}
 if (type==1){return dayformat;}
 if (type==3){return daymonthdisplay;}
 if (type==2){return timedisplay;}
 if(type==4){return datedisplay;}
if(type==5){return monthNamefull;}
if(type==6){return dayfulldisplay;}
if(type==7){return monthyeardisplay;}
}