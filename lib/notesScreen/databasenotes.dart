...
class DatabaseHelper {
  ...
  initDb() async {
    ...
    String path = join(documentDirectory.path, "notodonotes4_db.db");
  ...
  void _onCreate(Database db, int version) async {
    await db.execute(
        "CREATE TABLE $tableName(id INTEGER PRIMARY KEY, $columnItemName TEXT, $columnDateCreated TEXT, $columnTime TEXT, $columnMonth TEXT)");
    print("Table is created");
  }

//insertion
  Future<int> saveItem(NoDoItemNotes item) async {
